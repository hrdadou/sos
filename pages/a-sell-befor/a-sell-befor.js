...
Page({
    data: {
        ...
        cheoseList: [ {
            id: 1,
            url: "https://img.rekoon.cn/newHome/sold_home_ic_phone.png",
            title: "手机保卖"
        }, {
            id: 3,
            url: "https://img.rekoon.cn/newHome/sold_home_ic_pad.png",
            title: "平板保卖"
        }, {
            id: 2,
            url: "https://img.rekoon.cn/newHome/sold_home_ic_computer.png",
            title: "笔记本保卖"
        } ],
        commentList: [],
        commentTotal: 0,
        ...
        t.req("ident/hots", {}, "post").then(function(t) {
            if (0 == t.code) {
                ...
                var e = t.data.filter(function(t, n, e) {
                    return 14 == t.brandId;
                }), o = t.data.filter(function(t, n, e) {
                    return 14 != t.brandId;
                });
                n.setData({
                    showLoad: !1,
    ...
    onLoad: function(t) {
        n.Page.init(), this.getProductList(), this.goSellComment();
    },
    onReady: function() {},
    onShow: function() {
        var t = this;
    ...
    onShareAppMessage: function(n) {
        return "button" === n.from && console.log(n.target), {
            ...
            path: "/pages/a-buy/a-buy?fid=" + t.globalData.userInfo.openid,
            success: function(t) {}
        };
    }
});